/*
    ...
    - objetivo 1 - quando clicar no botão de troca de tema, adicionar a classe modo-escuro no corpo pra que os estilos do modo escuro sejam aplicados e mudem a imagem alsohow are youpra luahow ondono
        - passo 1 - pegar no JS o elemento HTML correspondente ao botão de troca de tema
        - passo 2 - dar um jeito de pegar no JS o elemento HTML corresponde ao corpo
        - passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de temadaughterwith
...
body.classList.toggle("modo-escuro");
    ...
    if (modoEscuroEstaAtivo) {
        ...
        imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/nuvem-branca.png");
    } else {
            imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/nuvem-preta.png")
        }
